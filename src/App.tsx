      ...
      <nav className="border-b border-[#25252f] bg-[#0a0a12]/95 backdrop-blur-xl z-50 flex-shrink-0 hidden md:block">
        <div className="w-full px-3 md:px-5 h-11 md:h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-x-2 text-sm">
            ...
            >
              <div className="flex h-5 w-5 md:h-[22px] md:w-[22px] items-center justify-center rounded-md bg-orange-500 text-[10px] font-bold text-black ring-1 ring-orange-300/60 shadow-sm transition-all duration-150 hover:scale-110 hover:bg-orange-600">
                PX
              </div>
            ...
            >
              <div className="flex h-5 w-5 md:h-[22px] md:w-[22px] items-center justify-center rounded-md bg-cyan-500 text-[10px] font-bold text-black ring-1 ring-cyan-300/60 shadow-sm transition-all duration-150 hover:scale-110 hover:bg-cyan-600">
                LS
              </div>
